...
import uno.a.factoryRequest.FactoryRequest;
import uno.a.factoryRequest.RequestInformation;
import uno.a.helpers.Configuration;
import uno.a.helpers.JsonAssert;
...
public class MyStepdefs {
    ...
    @Given("yo uso la authenticacion por {} 1")
    public void yoUsoLaAuthenticacionToken(String type) {
    ...
    @When("envio {} a {} con el user {} y password {} con el Body")
    public void iUpdateUserUsingHisUserPasswordAndABody(String method,String url, String user, String pwd, String body) {
    ...
    public void elprogaramfuncionacontoken() {
